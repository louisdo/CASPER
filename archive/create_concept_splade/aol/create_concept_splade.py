...
if __name__ == "__main__":
    vocab_path = "/scratch/lamdo/aol_concept_annotations/aol.2024.keywords.withlevel.json"

    with open(vocab_path) as f:
        temp = json.load(f)
        phrase_counter = {line["name"]: None for line in temp}
    ...
    model_name_on_hf = "lamdo/distilbert-base-uncased-aol-concepts"
