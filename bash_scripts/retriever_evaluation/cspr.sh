...
export OPENAI_API_KEY="none" # this is here because of a pyserini bug
...
MODEL_DIR="/scratch/lamdo/CSpR/finetuning/distilbert+15k+inplace+keepsurface+cspr+combined/2026-06-28_11AM/checkpoint-52000"
CONFIG_PATH="/home/lamdo/CSpR/train/conf/cspr_keep_surface+combined.yaml"

# MODEL_DIR="/scratch/lamdo/CSpR/finetuning/distilbert+15k+cspr/2026-06-24_11PM/"
# CONFIG_PATH="/home/lamdo/CSpR/train/conf/cspr_new.yaml"

# MODEL_DIR="lamdo/casper"
# CONFIG_PATH="/home/lamdo/CSpR/evaluation/cspr/conf/casper.yaml"

MODEL_DIR="/scratch/lamdo/CSpR/finetuning/gte-en-mlm-base+15k+inplace+keepsurface+cspr/2026-06-30_07AM/multislerp_16-20k"
CONFIG_PATH="/home/lamdo/CSpR/train/conf/cspr_keep_surface+gte.yaml"
...
for dataset in "${datasets[@]}"; do
    ...
    python -m evaluation.cspr.index \
        ...
        --top_k_token 1024 --top_k_phrase 1024
