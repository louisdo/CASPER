...
if __name__ == "__main__":
    vocab_path = "/home/lamdo/splade/create_concept_splade/eru_kg_dataset/vocab_combined.json"

    with open(vocab_path) as f:
        phrase_counter = Counter(json.load(f))
    ...
    model_name_on_hf = "lamdo/distilbert-base-uncased-phrase-20kaddedphrases_erukgds"
