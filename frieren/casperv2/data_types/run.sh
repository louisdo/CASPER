...
--special_token '<hier-concept>' > log.citation_context
...
--metadata_file /scratch/academic_online/s2orc/metadata_from_api/metadata_from_api.3.jsonl \
--special_token '<hier-concept>' > log.cocit
...
--metadata_file /scratch/academic_online/s2orc/metadata_from_api/metadata_from_api.3.jsonl \
--special_token '<hier-concept>' > log.title