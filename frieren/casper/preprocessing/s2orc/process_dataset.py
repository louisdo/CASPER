...
def main():
    ...
    # We need to use Semantic Scholar's paper API to get information regarding
    # fields of study since this information is not available in S2ORC
    # Therefore, metadata_file is needed
